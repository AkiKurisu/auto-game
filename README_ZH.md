...
![Auto Game](./docs/images/banner.png)
...
- **DotCraft** — 打开 **Plugins**，在 **Create** 旁边的菜单里选 **Add marketplace**，填入 `AkiKurisu/auto-game`。
  ...
  ![DotCraft 中的 Auto Game 插件](./docs/images/dotcraft-auto-game-plugin.png)

- **Codex** — 运行 `codex plugin marketplace add AkiKurisu/auto-game`。

  ![Codex 中的 Auto Game 插件](./docs/images/codex-auto-game-plugin.png)
